...
namespace edge_matching_puzzle
{
    class emp_gui: public simple_gui::simple_gui
    {
      public:
        inline
        emp_gui( const unsigned int & p_puzzle_width
        ...
        inline
        void display(const emp_FSM_situation & p_situation);

        inline
        ~emp_gui(void);

        inline
        const lib_bmp::my_bmp & get_picture(const unsigned int & p_piece_id) const;

      private:

        inline
        void set_piece_without_lock( const unsigned int & p_x
                                   , const unsigned int & p_y
                                   , const emp_types::t_piece_id & p_id
                                   , const emp_types::t_orientation & p_orientation
                                   );
        ...
        inline
        void clear_piece_without_lock( const unsigned int & p_x
                                     , const unsigned int & p_y
                                     );
