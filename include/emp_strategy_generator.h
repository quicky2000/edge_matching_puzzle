...
namespace edge_matching_puzzle
{
    ...
    class emp_strategy_generator
    {
      ...
      public:
        ...
        inline
        emp_strategy_generator(const std::string & p_name
        ...
        [[nodiscard]] inline
        const unsigned int &
        get_position_index(const std::pair<unsigned int,unsigned int> & p_position)const;
        ...
        [[nodiscard]] inline
        const unsigned int &
        get_position_index(const unsigned int & p_x
        ...
        get_position(const unsigned int & p_index)const;
        ...
        inline
        virtual
        ~emp_strategy_generator()= default;
    ...
    //----------------------------------------------------------------------------
    const unsigned int &
    emp_strategy_generator::get_width()const
    {
        return m_width;
    }
    ...
    //----------------------------------------------------------------------------
    const unsigned int &
    emp_strategy_generator::get_height()const
    {
        return m_height;
    }
    ...
    [[maybe_unused]]
    const std::string &
    emp_strategy_generator::get_name()const
    {
        return m_name;
    }
    ...
    //----------------------------------------------------------------------------
    void
    emp_strategy_generator::add_coordinate(const unsigned int & p_x
                                          ,const unsigned int & p_y
                                          )
    {
        assert(p_x < m_width);
    ...
    //--------------------------------------------------------------------------
    const unsigned int &
    emp_strategy_generator::get_position_index(const std::pair<unsigned int,unsigned int> & p_position)const
    {
    ...
    //--------------------------------------------------------------------------
    const unsigned int &
    emp_strategy_generator::get_position_index(const unsigned int & p_x
                                              ,const unsigned int & p_y
                                              )const
    {
    ...
    //--------------------------------------------------------------------------
    const std::pair<unsigned int,unsigned int> &
    emp_strategy_generator::get_position(const unsigned int & p_index)const
    {
