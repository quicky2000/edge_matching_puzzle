...
#ifndef FEATURE_DISPLAY_ALL
#define FEATURE_DISPLAY_ALL
...
{
  class feature_display_all: public algo_based_feature<FSM_framework::algorithm_deep_raw>
  {
  public:
    inline feature_display_all(const emp_piece_db & p_db,
  ...
  //----------------------------------------------------------------------------
  feature_display_all::feature_display_all(const emp_piece_db & p_db,
                                           const emp_FSM_info & p_info,
                                           emp_gui & p_gui):
    ...
    //----------------------------------------------------------------------------
    void feature_display_all::display_specific_situation(const emp_FSM_situation & p_situation)
    {
    ...
    //----------------------------------------------------------------------------
    const std::string & feature_display_all::get_class_name(void) const
      {
        return m_class_name;
      }
 }

#endif // FEATURE_DISPLAY_ALL
//EOF
