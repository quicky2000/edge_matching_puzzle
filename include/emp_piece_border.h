...
namespace edge_matching_puzzle
{
  ...
  {
  public:
    inline emp_piece_border(const emp_types::t_piece_id & p_id,
                            const std::array<emp_types::t_color_id,((unsigned int)(emp_types::t_orientation::WEST))+1> & p_colours
                            );
    inline emp_piece_border(const emp_piece & p_piece);
  ...
  emp_piece_border::emp_piece_border(const emp_types::t_piece_id & p_id,
	...
	init();
      ...
      //----------------------------------------------------------------------------
      const emp_types::t_color_id & emp_piece_border::get_center_color(void)const
	{
	  return m_center_color;
	}
    
      //----------------------------------------------------------------------------
      void emp_piece_border::init(void)
      {
	...
	m_center_color = get_color(m_center_orientation);
      ...
      //----------------------------------------------------------------------------
      const std::pair<emp_types::t_color_id, emp_types::t_color_id> & emp_piece_border::get_border_colors(void)const
	{
	  return m_border_colors;
	}
      //----------------------------------------------------------------------------
      const std::pair<emp_types::t_orientation,emp_types::t_orientation> & emp_piece_border::get_colors_orientations(void)const
      {
